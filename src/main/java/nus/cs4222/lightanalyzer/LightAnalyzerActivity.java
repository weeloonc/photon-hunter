 ...
 * 'Light.csv':
 * Reading Number, Unix timestamp, Human Readable Time, Light reading (lux)
 *
...
public class LightAnalyzerActivity
    ...
    public void openLogFile() throws IOException {
        ...
        File logDirectory = new File(Environment.getExternalStorageDirectory(), "LightAnalyzer");
        logDirectory.mkdirs();
     ...
     */
    private void logLightReading(long timestamp, float lux) {
